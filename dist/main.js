...
eval("\n/**\n * This code has refactored from the following code:\n *\n * ReactCompass - a carefully crafted Compass component for React.\n * https://github.com/virtyaluk/react-compass\n *\n * Copyright (c) 2016 Bohdan Shtepan\n * http://modern-dev.com/\n *\n * Licensed under the MIT license.\n *\n * @flow\n */\nvar __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {\n    if (k2 === undefined) k2 = k;\n    var desc = Object.getOwnPropertyDescriptor(m, k);\n    if (!desc || (\"get\" in desc ? !m.__esModule : desc.writable || desc.configurable)) {\n      desc = { enumerable: true, get: function() { return m[k]; } };\n    }\n    Object.defineProperty(o, k2, desc);\n}) : (function(o, m, k, k2) {\n    if (k2 === undefined) k2 = k;\n    o[k2] = m[k];\n}));\nvar __setModuleDefault = (this && this.__setModuleDefault) || (Object.create ? (function(o, v) {\n    Object.defineProperty(o, \"default\", { enumerable: true, value: v });\n}) : function(o, v) {\n    o[\"default\"] = v;\n});\nvar __importStar = (this && this.__importStar) || function (mod) {\n    if (mod && mod.__esModule) return mod;\n    var result = {};\n    if (mod != null) for (var k in mod) if (k !== \"default\" && Object.prototype.hasOwnProperty.call(mod, k)) __createBinding(result, mod, k);\n    __setModuleDefault(result, mod);\n    return result;\n};\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst react_1 = __importStar(__webpack_require__(/*! react */ \"react\"));\n__webpack_require__(/*! ./style.css */ \"./src/style.css\");\nconst react_style_normalizer_1 = __importDefault(__webpack_require__(/*! react-style-normalizer */ \"./node_modules/react-style-normalizer/src/index.js\"));\nconst Compass = ({ directionNames = ['N', 'NE', 'E', 'SE', 'S', 'SO', 'O', 'NO'] }) => {\n    const [compass, setCompass] = (0, react_1.useState)(0);\n    (0, react_1.useEffect)(() => {\n        start();\n    }, []);\n    const start = () => __awaiter(void 0, void 0, void 0, function* () {\n        // https://dev.to/orkhanjafarovr/real-compass-on-mobile-browsers-with-javascript-3emi\n        window.addEventListener(\"deviceorientationabsolute\", onOrientationEventAbsolute, true);\n        function onOrientationEventAbsolute(event) {\n            const compass = Math.abs(event.alpha - 360);\n            setCompass(compass);\n        }\n    });\n    const formatDirection = (dir) => {\n        return Number(Number(dir).toFixed(0));\n    };\n    const directionName = (dir) => {\n        const sections = directionNames.length;\n        const sect = 360 / sections;\n        let x = Math.floor((dir + sect / 2) / sect);\n        x = x >= sections ? 0 : x;\n        return directionNames[x];\n    };\n    return (react_1.default.createElement(\"div\", { className: \"center compass\" },\n        react_1.default.createElement(\"div\", { className: \"compass__windrose\", style: (0, react_style_normalizer_1.default)({ transform: `rotate(-${compass}deg)` }) },\n            [...Array(10)].map((k, i) => react_1.default.createElement(\"div\", { className: \"compass__mark\", key: i + 1 })),\n            react_1.default.createElement(\"div\", { className: \"compass__mark--direction-h\" }),\n            react_1.default.createElement(\"div\", { className: \"compass__mark--direction-v\" })),\n        react_1.default.createElement(\"div\", { className: \"compass__arrow-container\" },\n            react_1.default.createElement(\"div\", { className: \"compass__arrow\" }),\n            react_1.default.createElement(\"div\", { className: \"compass__labels\" },\n                react_1.default.createElement(\"span\", null))),\n        react_1.default.createElement(\"div\", { className: \"degrees\" },\n            react_1.default.createElement(\"span\", null,\n                formatDirection(compass),\n                react_1.default.createElement(\"sup\", null, \"o\")),\n            \" \",\n            react_1.default.createElement(\"span\", null, directionName(formatDirection(compass))))));\n};\nexports[\"default\"] = Compass;\n\n\n//# sourceURL=webpack://react-compass-component/./src/index.tsx?");
